...
User.create(user_id: "WkZOFnaNDtb9H6Aa", role: "teacher", parameter_id: "U9xvD37sOc4fQmwX")
User.create(user_id: "Wc5lpw2YMRIxuDpM", role: "teacher", parameter_id: "uOajLLUuhDXHj7cQ")
User.create(user_id: "0qqx5ugm42UFFrOV", role: "teacher", parameter_id: "kbL1ZQQVhmdFtrWk")
User.create(user_id: "eKwToooiFnyI8BHC", role: "student", parameter_id: "MjlPd28fNycJAsxZ")
User.create(user_id: "eugakA6u1ZXUfuzR", role: "teacher", parameter_id: "yI8LbW6NKVKWP5kF")
