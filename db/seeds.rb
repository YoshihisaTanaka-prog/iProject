...
User.create(user_id: "0qqx5ugm42UFFrOV", role: "teacher")
User.create(user_id: "eKwToooiFnyI8BHC", role: "student")
User.create(user_id: "eugakA6u1ZXUfuzR", role: "teacher")
User.create(user_id: "UfDI1Re0cx4P1Ikm", role: "student")