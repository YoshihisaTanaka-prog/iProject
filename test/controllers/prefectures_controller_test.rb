...
class PrefecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prefecture" do
    assert_difference('Prefecture.count') do
      post prefectures_url, params: { prefecture: { name: @prefecture.name, objectId: @prefecture.objectId, regionId: @prefecture.regionId } }
    end
  ...
  test "should update prefecture" do
    patch prefecture_url(@prefecture), params: { prefecture: { name: @prefecture.name, objectId: @prefecture.objectId, regionId: @prefecture.regionId } }
